...
class Settings(BaseSettings):
    ...
    # Visual page embedding: qwen3-vl-embedding uses DashScope native
    # multimodal embedding API, not the OpenAI-compatible /embeddings adapter.
    visual_embedding_provider: str = "local"
    visual_embedding_model: str = "qwen3-vl-embedding"
    visual_embedding_dimension: int = 1024
    visual_embedding_version: str = "vis_202606301200_qwen3-vl-embedding_1024_page-v1"
