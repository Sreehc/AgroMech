...
from agromech_api.image_ingestion import process_image_document
...
def test_pdf_pages_are_rendered_to_page_assets_with_page_locator(tmp_path) -> None:
    ...
    result = process_image_document(engine, "doc-1", ocr_reader=lambda _path: "Hydraulic diagram OCR")
